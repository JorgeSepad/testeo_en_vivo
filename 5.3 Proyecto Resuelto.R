...
# Cargamos los datos
library(readxl)
Datos_Modelo <- read_excel("C:/Users/msajsp/OneDrive - Mayr-Melnhof Group/Documents/DATA SCIENCE/Curso de Introducción/5. Proyecto 2 - Machine learning-20250814T164719Z-1-001/5. Proyecto 2 - Machine learning/Datos_Modelo.xlsx", 
                           sheet = "Datos")
